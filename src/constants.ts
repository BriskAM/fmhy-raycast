...
export const CATEGORY_PAGES: CategoryPage[] = [
  ...
  { name: "Internet Tools", path: "internet-tools.md", category: "internet-tools" },
  { name: "Social Media Tools", path: "social-media-tools.md", category: "social-media-tools" },
  ...
  { name: "Developer Tools", path: "developer-tools.md", category: "developer-tools" },
  { name: "Unsafe Sites", path: "unsafe.md", category: "unsafe" },
  { name: "Recently Removed", path: "recently-removed.md", category: "recently-removed" },
